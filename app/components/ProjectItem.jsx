      ...
      {project.background && (
        <div className="project-image-wrapper">
          <div className="event-fade-layer">
            <Image
              className={`event-background${project.backgroundPositionTop ? ' event-background-top' : ''}`}
          ...
          {project.links.map((link, index) => (
            <span key={index}>
              ...
              <a className="link" href={link.url}>
                {link.name.toLowerCase() === "repo" ? (
                  <svg className="gh-icon" viewBox="0 0 16 16" width="25" height="25" fill="currentColor" aria-label="repo">
